...
import DaochatABI from "./daochatABI.json"
import { EthersOptions, GroupResponse, EthersNetwork } from "./types"

export default class DaochatEthers {
    ...
    constructor(networkOrEthereumURL: EthersNetwork | string = "sepolia", options: EthersOptions = {}) {
        ...
        switch (networkOrEthereumURL) {
            ...
            default:
                if (options.address === undefined) {
                    throw new Error(`You should provide a Daochat contract address for this network`)
                }
        ...
        this._contract = new Contract(options.address, DaochatABI, provider)
    }
