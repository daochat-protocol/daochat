...
import DaochatSubgraph from "./subgraph"
...
describe("DaochatSubgraph", () => {
    let daochat: DaochatSubgraph

    describe("# DaochatSubgraph", () => {
        it("Should instantiate a DaochatSubgraph object", () => {
            daochat = new DaochatSubgraph()
