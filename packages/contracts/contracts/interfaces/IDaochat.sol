...
/// @title Daochat contract interface.
interface IDaochat {
    error Daochat__CallerIsNotTheGroupAdmin();
    error Daochat__MerkleTreeDepthIsNotSupported();
    error Daochat__MerkleTreeRootIsExpired();
    error Daochat__MerkleTreeRootIsNotPartOfTheGroup();
    error Daochat__YouAreUsingTheSameNillifierTwice();
    ...
    /// @dev Emitted when a Daochat proof is verified.
    /// @param groupId: Id of the group.
    /// @param merkleTreeRoot: Root of the Merkle tree.
    /// @param nullifierHash: Nullifier hash.
    /// @param externalNullifier: External nullifier.
    /// @param signal: Daochat signal.
    event ProofVerified(
        uint256 indexed groupId,
