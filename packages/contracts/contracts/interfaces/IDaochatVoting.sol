...
/// @title DaochatVoting contract interface.
interface IDaochatVoting {
    error Daochat__CallerIsNotThePollCoordinator();
    error Daochat__MerkleTreeDepthIsNotSupported();
    error Daochat__PollHasAlreadyBeenStarted();
    error Daochat__PollIsNotOngoing();
